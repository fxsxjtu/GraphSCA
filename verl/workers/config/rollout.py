...
class RolloutConfig(BaseConfig):
    ...
    # Embedding extraction for step-level rewards
    extract_embeddings: bool = False
    embedding_layer: int = 30

    # Streaming reward computation (memory-efficient)
    # When enabled, rewards are computed immediately after extracting embeddings
    # to avoid storing large embedding tensors in memory
    streaming_reward_computation: bool = False
